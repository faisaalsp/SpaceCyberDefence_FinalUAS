...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './Bullet.ts', './Enemy.ts', './Home.ts', './MainGame.ts', './MusicManager.ts', './PlayAgain.ts', './Playbutton.ts', './Ship.ts', './ShipCollide.ts'], function () {
  return {
...
System.register("chunks:///_virtual/MainGame.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Enemy.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createForOfIteratorHelperLoose, cclegacy, _decorator, Prefab, Node, Label, AudioClip, AudioSource, Vec3, instantiate, Collider2D, Contact2DType, Vec2, Component, Enemy;
  ...
  return {
    ...
    execute: function () {
      ...
      var MainGame = exports('MainGame', (_dec = ccclass('MainGame'), _dec2 = property({
        ...
        type: Label
      }), _dec6 = property(AudioClip), _dec7 = property(AudioClip), _dec8 = property(AudioClip), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function MainGame() {
          ...
          _initializerDefineProperty(_this, "backgroundMusic", _descriptor6, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "fire", _descriptor7, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "crash", _descriptor8, _assertThisInitialized(_this));
        ...
        _proto.playBackgroundMusic = function playBackgroundMusic() {
          if (this.backgroundMusic) {
            var audioSource = this.getComponent(AudioSource) || this.addComponent(AudioSource);
            audioSource.clip = this.backgroundMusic;
            audioSource.loop = false; // Untuk memastikan musik diputar berulang kali

            audioSource.play();
          }
        };

        _proto.fireSound = function fireSound() {
          if (this.fire) {
            var audioSource = this.getComponent(AudioSource) || this.addComponent(AudioSource);
            audioSource.clip = this.fire;
            audioSource.loop = false; // Untuk memastikan musik diputar berulang kali
        ...
        _proto.enemyCrash = function enemyCrash() {
          if (this.crash) {
            var audioSource = this.getComponent(AudioSource) || this.addComponent(AudioSource);
            audioSource.clip = this.crash;
            audioSource.loop = false; // Untuk memastikan musik diputar berulang kali
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "backgroundMusic", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "fire", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "crash", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/MusicManager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, AudioClip, Button, Label, AudioSource, director, Component;
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "64235zBOuZPebOVjmSkfz7y", "MusicManager", undefined);

      var ccclass = _decorator.ccclass,
          property = _decorator.property;
      var MusicManager = exports('MusicManager', (_dec = ccclass('MusicManager'), _dec2 = property(AudioClip), _dec3 = property(Button), _dec4 = property(Label), _dec5 = property(Button), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inheritsLoose(MusicManager, _Component);
        ...
        function MusicManager() {
          ...
          _initializerDefineProperty(_this, "backgroundMusic", _descriptor, _assertThisInitialized(_this)); // Tautan ke file audio MP3 di editor Cocos Creator


          _initializerDefineProperty(_this, "musicButton", _descriptor2, _assertThisInitialized(_this)); // Node button untuk toggle music


          _initializerDefineProperty(_this, "buttonLabel", _descriptor3, _assertThisInitialized(_this)); // Label pada button untuk menampilkan status


          _initializerDefineProperty(_this, "creditButton", _descriptor4, _assertThisInitialized(_this));
        ...
        _proto.start = function start() {
          // Inisialisasi audio source dan mulai memutar musik
          this.audioSource = this.getComponent(AudioSource) || this.addComponent(AudioSource);
          this.playBackgroundMusic();

          if (this.creditButton) {
            this.creditButton.node.on('click', this.credit, this);
          } // Tambahkan event listener untuk button


          if (this.musicButton) {
            this.musicButton.node.on('click', this.onToggleMusic, this);
          } // Setel label awal berdasarkan status musik


          this.updateButtonLabel();
        };

        _proto.credit = function credit() {
          director.loadScene('credit');
        };

        _proto.playBackgroundMusic = function playBackgroundMusic() {
          if (this.backgroundMusic && this.audioSource) {
            this.audioSource.clip = this.backgroundMusic;
            this.audioSource.loop = true; // Untuk memastikan musik diputar berulang kali
        ...
        _proto.updateButtonLabel = function updateButtonLabel() {
          if (this.audioSource && this.buttonLabel) {
            if (this.audioSource.playing) {
              this.buttonLabel.string = 'MUTE';
            } else {
              this.buttonLabel.string = 'MUSIC';
            }
          }
        };

        return MusicManager;
      }(Component), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "backgroundMusic", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "buttonLabel", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "creditButton", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/Ship.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, AudioClip, Vec2, Collider2D, Contact2DType, AudioSource, ParticleSystem2D, director, Button, RigidBody2D, Component;
  ...
  return {
    ...
    execute: function () {
      ...
      var Ship = exports('Ship', (_dec = ccclass('Ship'), _dec2 = property({
        type: Node
      }), _dec3 = property(Node), _dec4 = property(AudioClip), _dec5 = property(Node), _dec(_class = (_class2 = (_class3 = /*#__PURE__*/function (_Component) {
        ...
        function Ship() {
          ...
          _initializerDefineProperty(_this, "backgroundMusic", _descriptor3, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "buttonNode", _descriptor4, _assertThisInitialized(_this));

          return _this;
        }

        var _proto = Ship.prototype; // Node yang akan berisi tombol

        _proto.start = function start() {
          // Tambahkan event listener klik mouse
          this.node.on(Node.EventType.MOUSE_DOWN, this.onMouseDown, this);
          var collider = this.fighterPlane.getComponent(Collider2D);
          collider.on(Contact2DType.BEGIN_CONTACT, this.onCollide, this); // Jadwalkan tampilan tombol setiap 10 detik

          this.schedule(this.showButton, 10);
        };
        ...
        _proto.playBackgroundMusic = function playBackgroundMusic() {
          if (this.backgroundMusic) {
            var audioSource = this.getComponent(AudioSource) || this.addComponent(AudioSource);
            audioSource.clip = this.backgroundMusic;
            audioSource.loop = true; // Untuk memastikan musik diputar berulang kali
        ...
        _proto.onCollide = function onCollide(selfCollider, otherCollider) {
          ...
          }, 1000); // 3000 milidetik sama dengan 3 detik
        };

        _proto.showButton = function showButton() {
          if (this.buttonNode) {
            this.buttonNode.active = true;
            this.buttonNode.on(Button.EventType.CLICK, this.onButtonClick, this);
          }
        };

        _proto.onButtonClick = function onButtonClick() {
          if (this.buttonNode) {
            this.buttonNode.active = false; // Sembunyikan tombol setelah diklik
            // Nonaktifkan boxCollider dan rigidbody pada fighterPlane

            var collider = this.fighterPlane.getComponent(Collider2D);
            var rigidBody = this.fighterPlane.getComponent(RigidBody2D);
            ...
            } // Aktifkan kembali boxCollider dan rigidbody setelah 3 detik
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "backgroundMusic", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "buttonNode", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
